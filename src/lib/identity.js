// Integración con el vault de identidad (id.closer.click) y con la primitiva de
// DELEGACIÓN de capacidades (closer-click-identity v0.10.0).
//
...
import { makeDeviceKey, pubkeyId } from '@closerclick/closer-click-identity/capabilities'

let identity = null
let myPubkey = null

/** Conecta al vault (iframe id.closer.click). Idempotente. */
...
// URL del bridge cerrado de "here" (mismo origen que POST /here de geo.closer.click).
const HERE_BRIDGE_BASE = 'https://geo.closer.click'
 ...
 * @param {string} [p.baseUrl]  default https://geo.closer.click
