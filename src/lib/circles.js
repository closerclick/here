...
// el círculo a su DUEÑO (contrato del bridge cerrado en closer-click-geo):
//
...
export async function distributeCircleKey ({ circleKey, members, identity, deliver } = {}) {
  ...
  // TODO(transporte): cuando @closerclick/closer-click-proxy-client esté cableado
...
// (store.closer.click, @closerclick/closer-click-store). localStorage queda solo
...
//
// TODO(store): reemplazar este repo en memoria por @closerclick/closer-click-store
