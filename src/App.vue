...
// <closer-click-profile> (mi propio perfil). El provider se cablea con el vault;
...
onMounted(async () => {
  ...
  // TODO(profile): import('@closerclick/closer-click-profile') +
  //   createVaultProfileProvider({ identity, reputation }) y abrir mode="self".
})

function openMyProfile () {
  profileOpen.value = true
  // TODO(profile): renderizar <closer-click-profile modal mode="self"
