// Service worker estándar del ecosistema (CONVENCIONES §3): navegación
...
self.addEventListener('fetch', e => {
  ...
  // Nunca interceptar otros orígenes (id.closer.click, store.closer.click,
  // geo.closer.click, jsDelivr, GoatCounter…).
