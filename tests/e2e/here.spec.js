...
// de verdad. NO mockea nada: el vault id.closer.click se carga en un iframe y,
...
test.describe('here — flujos core', () => {
  ...
  test('genera la config: pinta el QR (canvas) y muestra el summary', async ({ page }) => {
    ...
    await expect(page.locator('.mono:visible', { hasText: 'https://geo.closer.click/here' }).first())
      .toBeVisible()
